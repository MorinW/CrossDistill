...
# from pretrain_models_load_downstream import BertForSequenceClassification, AlbertForSequenceClassification
# from pretrain_models_load_ds_no_emb import BertForSequenceClassification, AlbertForSequenceClassification

# from pretrain_models_load_ds_3_classifier import BertForSequenceClassification, AlbertForSequenceClassification
...
def train(args, train_dataset, model, tokenizer):
    ...
    for ep in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            outputs = model(**inputs, ada_prob=ada_prob)
...
def load_and_cache_examples(args, task, tokenizer, data_type='train'):
    ...
    if os.path.exists(cached_features_file):
        ...
        if task in ['mnli', 'mnli-mm'] and 'roberta' in args.model_type:
            ...
            logger.info("label_list are diffferent %s", str(label_list))
        ...
        logger.info("label_list %s", str(label_list))
